...
.fa-play:before {
    ...
    <div id="text" class="container">
            <div class="row">
             ...
             <iframe src="https://player.vimeo.com/video/336305846" width="100%" height="100%" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
       ...
       <div style="height:400px;width:400px;overflow:scroll;overflow-x:hidden;overflow-y:scroll; color: white;">
           <h4 align='center'><b>COMMUNICATION SKILLS</b></h4>
...
<style>
  ...
  <div class="section section--search section--middle section--light section--search" >
    <div class="container">
  ...
  <div class="panel" >
    <div class="panel__body">
      ...
      <div class="downloads">
          ...
          <a target="_blank" class="downloads__download" href="../pdf/03-How_To_Greet_And_Meet_People.pdf">
            <div class="media">
              ...
              <div class="media-body media-middle">
               03-How_To_Greet_And_Meet_People.pdf
              </div>
            </div>
          </a>
